...
constexpr auto PackBigEndian24(uint32_t a, uint32_t b, uint32_t c) -> uint32_t {
    return (a << 16) + (b << 8) + c;
}
...
auto Read24(const std::vector<uint8_t>&, uint32_t) -> uint32_t;
...
auto Write24(std::vector<uint8_t>&, uint32_t, uint32_t) -> void;
